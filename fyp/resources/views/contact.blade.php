...
<!-- Mirrored from html.webtend.net/munfirm/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Dec 2024 04:36:36 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8" />
    ...
    <!-- Title -->
    <title>Munfirm - Agriculture & Organic Food HTML Template || Contact</title>
    <!-- Favicon Icon -->
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="contact-info-item wow fadeInUp delay-0-5s">
                            ...
                            <div class="content">
                                <h4>Email Us</h4>
                                <a href="mailto:organicfarm@mail.net">organicfarm@mail.net</a><br>
                                <a href="mailto:support@info.com">support@info.com</a><br>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-md-6">
                        <div class="contact-info-item wow fadeInUp delay-0-6s">
                            ...
                            <div class="content">
                                <h4>Phone Us</h4>
                                <a href="callto:+000(111)345678">+000 (111) 345 678</a><br>
        ...
        <section class="contact-form-area rel z-1 pt-100 rpt-70 pb-130 rpb-100">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <form id="contactForm" class="contact-form rmb-65 wow fadeInLeft delay-0-2s" name="contactForm" action="https://html.webtend.net/munfirm/assets/php/form-process.php" method="post">
...
<!-- Mirrored from html.webtend.net/munfirm/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Dec 2024 04:36:54 GMT -->
</html>
