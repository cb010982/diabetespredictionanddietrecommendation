...
<!-- Mirrored from html.webtend.net/munfirm/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Dec 2024 04:36:36 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8" />
    ...
    <!-- Title -->
    <title>Munfirm - Agriculture & Organic Food HTML Template || Checkout</title>
    <!-- Favicon Icon -->
...
<body>
    <div class="page-wrapper">
        ...
        <div class="checkout-form-area py-130 rpy-100">
            <div class="container">
               <div class="checkout-faqs wow fadeInUp delay-0-2s" id="checkout-faqs">
                    <div class="alert bg-lighter">
                    ...
                    <div class="alert bg-lighter">
                        <h6>Have a coupon? <a href="#" class="collapsed card-header" data-toggle="collapse" data-target="#collapse3" aria-expanded="false" aria-controls="collapse3">Click here to enter your code</a></h6>
                ...
                <h4 class="form-title mt-50 mb-25">Billing Details</h4>
                <form id="checkout-form" class="checkout-form wow fadeInUp delay-0-2s" name="checkout-form" action="#" method="post">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="payment-method mt-45 wow fadeInUp delay-0-2s">
                                ...
                                <ul id="paymentMethod" class="mb-30">
                                    ...
                                    <li class="custom-control custom-radio">
                                        ...
                                        <label class="custom-control-label" for="methodone" data-toggle="collapse" data-target="#collapseOne" aria-controls="collapseOne">Direct Bank Transfer <i class="fas fa-money-check"></i></label>
                                    ...
                                    <li class="custom-control custom-radio">
                                        ...
                                        <label class="custom-control-label collapsed" for="methodtwo" data-toggle="collapse" data-target="#collapseTwo" aria-controls="collapseTwo">Cash On Delivery <i class="fas fa-truck"></i></label>

                                        <div id="collapseTwo" class="collapse" data-parent="#paymentMethod" style="">
                                    ...
                                    <li class="custom-control custom-radio">
                                        ...
                                        <label class="custom-control-label collapsed" for="methodthree" data-toggle="collapse" data-target="#collapsethree" aria-controls="collapsethree">Paypal <i class="fab fa-cc-paypal"></i></label>

                                        <div id="collapsethree" class="collapse" data-parent="#paymentMethod" style="">
                                ...
                                <button type="button" class="theme-btn mt-15">Place order</button>
                            </div>
                        </div>
                        <div class="col-lg-5">
                            <div class="shoping-cart-total mt-45 wow fadeInUp delay-0-4s">
                                ...
                                <table>
                                    <tbody>
                                        <tr>
                                            <td>Fresh Gooseberry <strong>× 2</strong></td>
                                            <td>$303.00</td>
                                        </tr>
                                        <tr>
                                            <td>Chiken Egg’s <strong>× 2</strong></td>
                                            <td>$70.00</td>
                                        </tr>
                                        <tr>
                                            <td>Chiken Egg <strong>× 2</strong></td>
                                            <td>$50.00</td>
                                        </tr>
                                        <tr>
                                            <td>Shipping Fee</td>
