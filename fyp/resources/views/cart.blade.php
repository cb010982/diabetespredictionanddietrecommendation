...
<!-- Mirrored from html.webtend.net/munfirm/cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Dec 2024 04:36:36 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8" />
    ...
    <!-- Title -->
    <title>Munfirm - Agriculture & Organic Food HTML Template || Cart</title>
    <!-- Favicon Icon -->
            ...
            <div class="container">
                <div class="cart-item-wrap mb-35 wow fadeInUp delay-0-2s">
                    <div class="cart-single-item">
                        ...
                        <span class="product-total-price">500</span>
                    </div>
                    <div class="cart-single-item">
                        <button type="button" class="close"><span aria-hidden="true">&times;</span></button>
                        <div class="cart-img">
                    ...
                    <div class="cart-single-item">
                        <button type="button" class="close"><span aria-hidden="true">&times;</span></button>
                        <div class="cart-img">
                            <img src="assets/images/widgets/product4.png" alt="Product Image">
                        </div>
                ...
                <div class="row text-center text-lg-left align-items-center wow fadeInUp delay-0-2s">
                    ...
                    <div class="col-lg-6">
                        <div class="update-shopping text-lg-right">
                            <a href="shop-grid.blade.php" class="theme-btn style-two">shopping <i class="fas fa-angle-double-right"></i></a>
                            <a href="shop-grid.blade.php" class="theme-btn">update cart <i class="fas fa-angle-double-right"></i></a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="shoping-cart-total mt-45">
                                ...
                                <table>
                                    <tbody>
                                        <tr>
                                            <td>Cart Subtotal</td>
                                            <td class="sub-total-price">303.00</td>
                                        </tr>
                                        <tr>
                                            <td>Shipping Fee</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><strong class="total-price">400.00</strong></td>
                                        </tr>
                                    </tbody>
                                </table>
                                <a href="checkout.blade.php" class="theme-btn style-two mt-25 w-100">Proceed to checkout</a>
                            </div>
                        </div>
                    </div>
                </div>
