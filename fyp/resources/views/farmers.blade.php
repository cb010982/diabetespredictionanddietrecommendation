...
<!-- Mirrored from html.webtend.net/munfirm/farmers.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Dec 2024 04:35:12 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8" />
    ...
    <!-- Title -->
    <title>Munfirm - Agriculture & Organic Food HTML Template || Farmers</title>
    <!-- Favicon Icon -->
...
<body>
    <div class="page-wrapper">
        ...
        <section class="page-banner text-white py-165 rpy-130" style="background-image: url(assets/images/banner/banner.jpg);">
            <div class="container">
                <div class="banner-inner">
                    <h1 class="page-title wow fadeInUp delay-0-2s">Expert Farmers</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center wow fadeInUp delay-0-4s">
                            <li class="breadcrumb-item"><a href="index.blade.php">Home</a></li>
                            <li class="breadcrumb-item active">Expert Farmers</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <!-- Team Area Start -->
        <section class="team-page-area pt-130 rpt-100 pb-95 rpb-65">
           <div class="container">
               <div class="team-header mb-35">
                ...
                <div class="two-row-team-active">
                    ...
                    <div class="team-member wow fadeInUp delay-0-4s">
                        ...
                        <h4>Timothy N. Allison</h4>
                        <span class="designation">Bernard D. Brown</span>
                        <img class="team-bg" src="assets/images/team/team-member-bg.png" alt="Bg">
                    </div>
        ...
        <!-- Counter Area Start -->
        <div class="counter-area rel z-2 bg-light-green text-white pt-60 pb-25">
            <div class="container">
                <div class="counter-wrap">
                    <div class="counter-item">
                        <span class="count-text k-plus" data-speed="3000" data-stop="35">0</span>
                        <span>Saticfied Customer</span>
                    </div>
                    <div class="counter-item">
                        <span class="count-text k-plus" data-speed="3000" data-stop="48">0</span>
                        <span>Sale Products</span>
                    </div>
                    <div class="counter-item">
                        <span class="count-text plus" data-speed="3000" data-stop="23">0</span>
                        <span>Years Experience</span>
                    </div>
                    <div class="counter-item">
                        <span class="count-text plus" data-speed="3000" data-stop="67">0</span>
                        <span>Team Members</span>
                    </div>
                    <div class="counter-item">
                        <span class="count-text plus" data-speed="3000" data-stop="38">0</span>
        ...
        <section class="team-profile rel z-1 pt-130 rpt-100">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="team-profile-image rmb-65 wow fadeInLeft delay-0-2s">
        ...
        <section class="feedback-section pt-130 rpt-90 pb-130 rpb-100">
            <div class="container">
...
<!-- Mirrored from html.webtend.net/munfirm/farmers.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Dec 2024 04:35:17 GMT -->
</html>
